...
export function FeaturedListings() {
  ...
  const cars = [
    ...
    { id: 5, title: "2022 Hyundai Tucson AWD", price: "PKR 82,00,000", mileage: "18,000 km", city: "Faisalabad", fuel: "Petrol", trans: "Automatic", img: "https://images.unsplash.com/photo-1629897048514-3dd7414ccbbc?auto=format&fit=crop&w=800&q=80", badge: "Verified", badgeColor: "bg-[#16A34A]", dealer: "City Cars" },
    ...
    { id: 12, title: "2022 Toyota Fortuner Legender", price: "PKR 1,65,00,000", mileage: "25,000 km", city: "Islamabad", fuel: "Diesel", trans: "Automatic", img: "https://images.unsplash.com/photo-1535015173071-06c1128ee228?auto=format&fit=crop&w=800&q=80", badge: "Verified", badgeColor: "bg-[#16A34A]", dealer: "Elite Cars" },
  ];
